...
#define INF 999.0f
#define KNAPSACK_MAX_ENERGY 250
#define KNAPSACK_MAX_WATER 100
...
typedef struct {
    float total_energy_generation;
    float renewable_energy;
    float total_energy_demand;
    float battery_capacity;

    float total_water_availability;
    float freshwater_usage;
    float recycled_water;
    float total_water_demand;

    float total_useful_output;
